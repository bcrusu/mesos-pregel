...
type CountAlgorithmResult struct {
	Vertices int64 `protobuf:"varint,1,opt,name=vertices,proto3" json:"vertices,omitempty"`
	Edges    int64 `protobuf:"varint,2,opt,name=edges,proto3" json:"edges,omitempty"`
}

func (m *CountAlgorithmResult) Reset()                    { *m = CountAlgorithmResult{} }
func (m *CountAlgorithmResult) String() string            { return proto.CompactTextString(m) }
func (*CountAlgorithmResult) ProtoMessage()               {}
func (*CountAlgorithmResult) Descriptor() ([]byte, []int) { return fileDescriptorAlgorithm, []int{3} }

func (m *CountAlgorithmResult) GetVertices() int64 {
	if m != nil {
		return m.Vertices
	}
	return 0
...
func (m *CountAlgorithmResult) GetEdges() int64 {
	if m != nil {
		return m.Edges
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*CountAlgorithmResult)(nil), "protos.CountAlgorithmResult")
}
...
var fileDescriptorAlgorithm = []byte{
	...
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0xe2, 0x4f, 0xcc, 0x49, 0xcf,
	...
	0x4c, 0x4f, 0x25, 0xa8, 0xdf, 0x83, 0x4b, 0xc4, 0x39, 0xbf, 0x34, 0xaf, 0x04, 0xdd, 0x5e, 0x29,
	0x2e, 0x8e, 0xb2, 0xd4, 0xa2, 0x92, 0xcc, 0xe4, 0xd4, 0x62, 0xa8, 0x2e, 0x38, 0x5f, 0x48, 0x84,
	0x8b, 0x35, 0x35, 0x25, 0x3d, 0xb5, 0x18, 0xec, 0x0b, 0xe6, 0x20, 0x08, 0x27, 0x09, 0x12, 0x26,
	0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x87, 0xa6, 0xe6, 0x1f, 0x2d, 0x01, 0x00, 0x00,
}
