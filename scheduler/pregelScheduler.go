...
func NewPregelScheduler(executorInfo *mesos.ExecutorInfo, jobManager *jobManager.JobManager) *PregelScheduler {
	return &PregelScheduler{executorInfo: executorInfo, jobManager: jobManager}
}
